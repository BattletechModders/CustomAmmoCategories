  ...
  public class Targetting : BattleModModule {
    ...
    public override void ModStarts() {
      ...
      /*if (true) {
        ...
        Patch(typeof(CombatHUD), "Update", null, "CombatHUDUpdate");
        //CombatHUD.HookCalloutToggle(ToggleFriendlyFire);
        ...
        CustomAmmoCategoriesLog.Log.LogWrite("AIM patches implemented\n");
      }*/
    ...
    private static bool LeftAltPrevState = false;
    public static void CombatHUDUpdate(CombatHUD __instance) {
      bool LeftAltCurState = Input.GetKey(KeyCode.LeftAlt);
      if(LeftAltCurState != LeftAltPrevState) {
        LeftAltPrevState = LeftAltCurState;
        CustomAmmoCategoriesLog.Log.LogWrite("AIM left alt state changed:"+ LeftAltCurState + "\n");
        ToggleFriendlyFire(LeftAltCurState);
      }
    }
    ...
    public static void ToggleFriendlyFire(bool IsCallout) {
      try {
