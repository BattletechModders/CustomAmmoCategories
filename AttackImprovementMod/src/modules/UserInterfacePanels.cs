  ...
  public class UserInterfacePanels : BattleModModule {
    ...
    public static void ShowNumericInfo(CombatHUDActorDetailsDisplay __instance) {
      try {
        ...
        text.Append("<size="+Settings.ShowNumericInfoSize+"%><b>");
    ...
    private static void GetPreviewNumbers(Mech mech, ref float heat, ref float stab, ref string movement) {
      ...
      try {
        if (ActiveState is SelectionStateMove move) {
    ...
    public static void CorrectProjectedHeat(Mech __instance, ref int __result) {
      try {
