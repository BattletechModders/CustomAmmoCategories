...
namespace CustAmmoCategoriesPatches {
  ...
  public static class MissileEffect_FireShells {
    public static void Postfix(MissileEffect __instance, ref WeaponHitInfo hitInfo, int hitIndex, int emitterIndex, bool isIndirect) {
      ...
      ShrapnelHitRecord shrapnelHitRecord = CustomAmmoCategories.getShrapnelCache(__instance.hitInfo, thishitIndex);
...
namespace CustAmmoCategories {
  public static partial class CustomAmmoCategories {
    ...
    public static void RegisterFragWeaponEffect(this WeaponEffect we) {
      Log.LogWrite("RegisterFragWeaponEffect for "+we.gameObject.name+"\n");
      ...
      if ((UnityEngine.Object)ogameObject == (UnityEngine.Object)null) {
        ...
        GameObject gameObject = GameObject.Instantiate(ogameObject);
        ...
        if ((UnityEngine.Object)result == (UnityEngine.Object)null) {
          ...
          if (bWE != null) {
            CustomAmmoCategoriesLog.Log.LogWrite("Found ballistic " + "WeaponEffect-Weapon_AC2" + "/" + we.weapon.Name + "\n");
            FragBallisticEffect fbWE = gameObject.AddComponent<FragBallisticEffect>();
            fbWE.Init(bWE);
