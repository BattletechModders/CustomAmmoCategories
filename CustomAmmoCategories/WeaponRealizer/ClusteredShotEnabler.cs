...
namespace WeaponRealizer {
  ...
  static class ClusteredShotEnabler {
    ...
    static bool Prefix(ref WeaponHitInfo hitInfo, int groupIdx, int weaponIdx, Weapon weapon, float toHitChance,
      ...
      hitInfo.attackDirections = new AttackDirection[newNumberOfShots];
      hitInfo.secondaryHitLocations = new int[newNumberOfShots];
      hitInfo.secondaryTargetIds = new string[newNumberOfShots];
