    ...
    public class CustomBayShower : MonoBehaviour, IPointerEnterHandler
    {
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            if (parent != null)
            {
                ...
                this.parent.mainBay.gameObject.GetComponentInChildren<LocalizableText>(true).SetText(Core.Settings.MechBayDefaultLabel);
            }
        }
    }
            ...
            try
            {
                if (this.BayPanel != null)
                {
                    ...
                    if (uixPrfBttn_BASE_TabMedium_bays != null)
                    {
                        ...
                        // Set the main bay label
                        try
                        {
                            HBSDOTweenToggle toggle = uixPrfBttn_BASE_TabMedium_bays.gameObject.GetComponent<HBSDOTweenToggle>();
        ...
        public static void Postfix(MechBayPanel __instance, MechBayRowGroupWidget ___bayGroupWidget, SimGameState ___sim)
        {
            ...
            try
            {
                ...
                if (baysUI != null)
                {
                    ...
                    baysUI.mainBay.gameObject.GetComponentInChildren<LocalizableText>(true).SetText(Core.Settings.MechBayDefaultLabel);
                }
            }
            catch (Exception e)
            {
